...
<script language="JavaScript" src="/javascript/register-by-phone.js">
</script>
...
<head>
    <meta charset="UTF-8">
    <title>注册_华为帐号</title>
    <link type="text/css" rel="stylesheet" href="/css/register-by-phone.css">
</head>
<body>
<div class="header">
    ...
    <div class="bodyer-center">
        ...
        <div class="register-body">
            <div class="register-body-center">
                <form method="post" action="/servlet/RegisterByPhoneServlet">
                    <div class="country">
                        <div class="text">
                            <span>国
